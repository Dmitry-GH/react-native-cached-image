...
declare module "react-native-cached-image" {
  namespace CachedImage {
    ...
    interface ImageCacheManager {
      ...
      /** check is cached file already exist in cache. Resolves to cachedFilePath string or null if not exist */
      checkIsAlreadyExistCacheUrl(url: String, options:CacheOptions ): Promise<any>
